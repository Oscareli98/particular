...
public class TileParticular extends TileEntity{
	...
	public String toString() {
		...
		stringBuilder.append(String.format("TileParticular Data - xCoord: %d, yCoord: %d, zCoord: %d, customName: '%s', orientation: %s, state: %d\n", xCoord, yCoord, zCoord, customName, orientation, state));
